...
export const useDashboardStats = () => {
  return useQuery({
    ...
    queryFn: async (): Promise<DashboardStats> => {
      console.log('Carregando estatísticas melhoradas do dashboard...');
      ...
      // 3. Frequência últimos 7 dias úteis (excluindo sábados e domingos)
      ...
      // 6. Alunos em situação crítica (mais de 12 faltas)
      ...
      // 8. Distribuição de faltas por turno (simulado)
      ...
      // 9. Média de presença dos últimos 6 meses
      ...
      console.log('Estatísticas melhoradas carregadas com sucesso');
